...
/// Returns (alice_account, bob_account, alice_session, bob_session).
...
/// Create a Megolm group session pair (outbound sender, inbound receiver).
/// Returns (outbound_session, inbound_session).
pub fn create_megolm_session_pair() -> (GroupSession, InboundGroupSession) {
