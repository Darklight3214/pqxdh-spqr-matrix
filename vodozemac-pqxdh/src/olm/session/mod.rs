...
use super::shared_secret::{SharedPQXDHSecret, RemoteSharedPQXDHSecret};
...
impl Session {
    /// Constructor for the Initiator (Alice) using PQXDH
    pub(super) fn new_pqxdh(
        config: SessionConfig,
    ...
    /// Constructor for the Responder (Bob) using PQXDH
    pub(super) fn new_remote_pqxdh(
        config: SessionConfig,
